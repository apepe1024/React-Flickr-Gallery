Full Stack JavaScript Techdegree Project 9: React Flickr Gallery by Alessandro Pepe

Going for Exceeds Expectations goals.

This app requires the use of your own config.js file in the src folder.
Template as follows:
